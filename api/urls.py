...
from .views import (
    ...
    Last5IncomeCashView,
    SumIncomeCashView,
    SumIncomeCashGroupView,
    SumMonthlyIncomeView,
    SumPercentMonthlyIncomeView,
    UpdateIncomeCashView,
    DeleteIncomeCashView,
    AddOutcomeCashView,
    Last5OutcomeCashView,
    SumOutcomeCashView,
    SumOutcomeCashGroupView,
    SumMonthlyOutcomeView,
    SumPercentMonthlyOutcomeView,
    UpdateOutcomeCashView,
    DeleteOutcomeCashView,
    BalanceAPIView,
    AddMoneyBoxView,
    Last5MoneyBoxView,
    SumMoneyBoxView,
    SumMoneyBoxGroupView,
    SumMonthlyMoneyBoxView,
